-- Complete standalone booking system schema
-- This creates ALL tables needed for the booking system
...
-- Instructors table (for booking system)
...
-- Aircraft table (for booking system)
...
-- Success message
SELECT 'Complete booking system schema created successfully!' as message;
