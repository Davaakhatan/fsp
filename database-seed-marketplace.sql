...
('p1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'ppl', 'Private Pilot License (Part 141)', 'Comprehensive PPL program with structured curriculum and accelerated track options.', 'part_141', 11500, 14500, 'Based on 50 hours dual, 10 hours solo in C172S G1000 at $185/hr, instructor $65/hr, materials $800, checkride $700', 3, 5, '3-4 flights per week, full-time student', 35, 50, TRUE, TRUE),
('p1111112-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'ir', 'Instrument Rating (Part 141)', 'Accelerated instrument training with G1000 glass cockpit aircraft.', 'part_141', 9500, 12000, 'Based on 35 hours dual in C172S G1000, simulator $3000, materials $600, checkride $700', 2, 3, 'Full-time accelerated track', 35, 45, TRUE, TRUE),
('p1111113-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'cpl', 'Commercial Pilot License (Part 141)', 'Professional pilot training with multi-engine option.', 'part_141', 25000, 35000, 'Based on 120 hours complex/multi, instructor time, materials', 4, 7, 'Part-time to full-time', 190, 210, TRUE, TRUE),
('p1111114-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'cfi', 'Certified Flight Instructor', 'Build hours and start your aviation career as a CFI.', 'part_61', 5500, 7500, 'Based on 25 hours dual, materials, checkride', 2, 3, 'Already holds CPL', 0, 25, TRUE, FALSE);

-- Phoenix Aviation Programs
INSERT INTO programs (id, school_id, program_type, program_name, description, training_type, min_total_cost, max_total_cost, cost_assumptions, min_duration_months, max_duration_months, timeline_assumptions, minimum_hours, typical_hours, financing_available, va_approved) VALUES
('p2222221-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'ppl', 'Private Pilot License (Part 61)', 'Flexible Part 61 training tailored to your schedule.', 'part_61', 10000, 13000, 'Based on 70 hours in C172 at $150/hr, instructor $60/hr, materials $600', 4, 8, '2-3 flights per week, part-time', 40, 70, TRUE, TRUE),
('p2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'ir', 'Instrument Rating (Part 61)', 'Instrument training with flexible scheduling and experienced instructors.', 'part_61', 8500, 10500, 'Based on 50 hours dual, simulator time, materials', 3, 5, 'Part-time schedule', 40, 50, TRUE, TRUE);

-- Austin Flight School Programs
INSERT INTO programs (id, school_id, program_type, program_name, description, training_type, min_total_cost, max_total_cost, cost_assumptions, min_duration_months, max_duration_months, timeline_assumptions, minimum_hours, typical_hours, financing_available, va_approved) VALUES
('p3333331-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'ppl', 'Private Pilot License (Part 61)', 'Budget-friendly PPL training with personalized instruction.', 'part_61', 8500, 11000, 'Based on 65 hours in C152/C172 at $120-$145/hr, instructor $50/hr', 5, 10, '1-2 flights per week, weekend warrior', 40, 65, FALSE, FALSE);
...
('p4444441-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'ppl', 'Private Pilot License (Part 61)', 'Mountain flying training with emphasis on high-altitude operations.', 'part_61', 11000, 14000, 'Based on 70 hours, mountain terrain', 6, 12, 40, 70, FALSE, FALSE),
('p4444442-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'tailwheel', 'Tailwheel Endorsement', 'Learn to fly conventional gear aircraft.', 'part_61', 1500, 2500, 'Based on 10-15 hours dual', 0.5, 1, 0, 12, FALSE, FALSE);

-- Miami Flight Center Programs
INSERT INTO programs (id, school_id, program_type, program_name, description, training_type, min_total_cost, max_total_cost, cost_assumptions, min_duration_months, max_duration_months, timeline_assumptions, minimum_hours, typical_hours, financing_available, va_approved) VALUES
('p5555551-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'ppl', 'Private Pilot License (Part 141)', 'Structured Part 141 training with year-round flying weather.', 'part_141', 11000, 14000, 'Based on 45 hours in C172, accelerated program', 3, 6, 'Full-time accelerated', 35, 48, TRUE, FALSE),
('p5555552-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'multi', 'Multi-Engine Rating', 'Multi-engine training in Piper Seminole.', 'part_61', 4500, 6500, 'Based on 12-15 hours dual in Seminole', 1, 2, 'Add-on rating', 10, 13, TRUE, FALSE),
('p5555553-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'seaplane', 'Seaplane Rating', 'Seaplane training in beautiful South Florida.', 'part_61', 3500, 4500, 'Based on 10 hours in seaplane', 0.5, 1, 'Add-on rating', 5, 10, FALSE, FALSE);

-- Chicago Flight Academy Programs
INSERT INTO programs (id, school_id, program_type, program_name, description, training_type, min_total_cost, max_total_cost, cost_assumptions, min_duration_months, max_duration_months, timeline_assumptions, minimum_hours, typical_hours, financing_available, va_approved) VALUES
('p6666661-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 'ppl', 'Private Pilot License (Part 141)', 'Comprehensive Part 141 training with modern fleet.', 'part_141', 12000, 15000, 'Based on 50 hours in C172SP, structured curriculum', 3, 6, '3-4 flights per week', 35, 52, TRUE, TRUE),
('p6666662-6666-6666-6666-666666666666', '66666666-6666-6666-6666-666666666666', 'ir', 'Instrument Rating (Part 141)', 'Accelerated instrument training with simulator integration.', 'part_141', 9000, 11500, 'Based on 40 hours dual, simulator', 2, 4, 'Accelerated program', 35, 42, TRUE, TRUE);
